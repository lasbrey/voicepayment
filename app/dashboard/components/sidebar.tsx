...
const Header = () => {
  ...
  return (
    <header
      className={`fixed left-0 top-0 w-full z-99999 py-7 bg-black ${
        stickyMenu
          ? "shadow !py-4 transition duration-100"
          : ""
      }`}
    >
      <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0 lg:flex items-center justify-between relative">
          ...
          >
            <span className="block relative cursor-pointer w-5.5 h-5.5">
              ...
              <span className="block absolute w-full h-full rotate-45">
                <span
                  className={`block bg-white rounded-sm ease-in-out duration-200 delay-300 absolute left-2.5 top-0 w-0.5 h-0 ${
                    navigationOpen ? "h-full delay-[0]" : ""
                  }`}
                ></span>
                <span
                  className={`block bg-white rounded-sm ease-in-out duration-200 delay-400 absolute left-0 top-[.03rem] w-full h-0 ${
        ...
        {/* Nav Menu Start   */}
        <div
          className={`w-full lg:w-full h-0 lg:h-auto text-white invisible lg:visible lg:flex items-center justify-between ${
            navigationOpen &&
