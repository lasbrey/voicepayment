...
const About = () => {
  return (
    <>
      {/* <!-- ===== About Start ===== --> */}
      <section className="pb-20 pt-10 lg:pb-25 xl:pb-30 overflow-hidden">
          ...
          <div className="flex items-center gap-8 lg:gap-32.5">
            ...
            >
              <h2 className="relative font-bold text-black dark:text-white text-3xl xl:text-hero mb-6">
                A Fast, Secure
                <span className="ml-2 inline-block relative before:absolute before:bottom-2.5 before:left-0 before:w-full before:h-3 before:bg-titlebg dark:before:bg-titlebgdark before:-z-1">
                  Payment
                </span>
              </h2>
              <p>
                Enjoy swift, reliable payments on Solid – Send and receive money
                with friends and express yourself in each payment note and
                facilitate inclusivity for the visually impaired through
              ...
              <div className="mt-7.5 flex items-center gap-5">
                ...
                <div className="w-3/4">
                  <h5 className="text-black dark:text-white text-metatitle2 mb-0.5">
                    Secure login with voice authentication.
                  </h5>
                  <p>
                    Experience seamless access and enhanced security through
                    voice recognition.
                  </p>
                </div>
              </div>
              <div className="mt-7.5 flex items-center gap-5">
                ...
                <div className="w-3/4">
                  <h5 className="text-black dark:text-white text-metatitle2 mb-0.5">
                    Convenient payments with just a few taps.
                  </h5>
                  <p>
                    Make transactions effortlessly with a simple tap, ensuring a
        ...
        <div className="mx-auto max-w-c-1235 px-4 md:px-8 2xl:px-0 overflow-hidden">
          <div className="flex items-center gap-8 lg:gap-32.5">
            ...
            >
              <h2 className="relative font-bold text-black dark:text-white text-3xl xl:text-hero mb-6">
                Real time
                <span className="ml-2 inline-block relative before:absolute before:bottom-2.5 before:left-0 before:w-full before:h-3 before:bg-titlebg2 dark:before:bg-titlebgdark before:-z-1">
                  Notifications
                </span>
              </h2>
              <p>
