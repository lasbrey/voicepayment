            ...
            <form onSubmit={handleEmailSignIn}>
              <div className="flex flex-col lg:flex-row lg:justify-between gap-7.5 lg:gap-14 mb-7.5 lg:mb-12.5">
                <input
                  ...
                  className="p-2 w-full lg:w-1/2 !bg-white dark:!bg-black border-b border-stroke dark:border-strokedark focus-visible:outline-none focus:border-waterloo dark:focus:border-manatee focus:placeholder:text-black dark:focus:placeholder:text-white pb-3.5"
                />
