          ...
          <div className="flex lg:items-center lg:gap-8 xl:gap-32.5">
            <div className=" md:w-1/2">
              ...
              <h1 className="text-black dark:text-white text-3xl xl:text-hero font-bold mb-5 pr-16 ">
                A secure way to send joy their way.
              </h1>
              <p>
                Simplify online transactions with Solid! Send, receive, and
                request money effortlessly through voice-activated payments.
                Empowering the visually impaired for inclusive finance.
              </p>
